...
export default function Header() {
  ...
  return (
    <Navbar className="border-b-2">
      <Link
        to="/"
        className=" self-center text-center flex items-center whitespace-nowrap text-sm sm:text-xl font-semibold dark:text-white"
      >
        <span className=" mr-2  flex items-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg px-3 py-1 text-white">
         Connect
        </span>
        Verse
      </Link>
