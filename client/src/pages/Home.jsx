    ...
    <div>
      <div className="flex flex-col gap-6 p-28 max-w-6xl mx-auto">
        ...
        <p className="text-xs lg:text-sm text-gray-500">
          Discover a vibrant community where connections fuel creativity and
          knowledge blooms through diverse articles and tutorials.
        </p>
        <Link
          to="/search"
      ...
      <div className="bg-gray-100 rounded-lg  dark:bg-slate-700 p-3 lg:max-w-6xl lg:mx-auto">
        <CallToAction />
      </div>
      <div>
        {posts.length > 0 && (
          <div className="flex flex-col  max-w-6xl items-center p-8  mx-auto">
            ...
            <Link
              to="/search"
              className="hover:underline text-teal-500 text-sm "
            >
              View all posts
            </Link>
          </div>
